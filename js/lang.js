...
const TRANSLATIONS = {
  en: {
    ...
    order_vodafone_msg: 'Transfer to Vodafone Cash: <strong>XXXXXXXXXXX</strong>',
  ...
  ar: {
    ...
    order_instapay_msg: 'حوّلي على رقم الـ InstaPay: <strong>XXXXXXXXXXX</strong>',
    order_vodafone_msg: 'حوّلي على رقم فودافون كاش: <strong>XXXXXXXXXXX</strong>',
